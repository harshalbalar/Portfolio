...
export const dict = {
  de: {
    nav: { about: "Über mich", skills: "Fähigkeiten", languages: "Sprachen", work: "Projekte", contact: "Kontakt" },
    hero: {
      intro:
  ...
  en: {
    nav: { about: "About", skills: "Skills", languages: "Languages", work: "Work", contact: "Contact" },
    hero: {
      intro:
